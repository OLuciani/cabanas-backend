...
// Obtener clientId, clientSecret y refreshToken desde las variables de entorno
...
// Función para refrescar automáticamente el token de acceso
async function refreshAccessToken() {
  try {
    // Utiliza la función getAccessToken para obtener un nuevo token
...
// Ejecutar la función cada cierto tiempo (por ejemplo, cada día)
setInterval(refreshAccessToken, 24 * 60 * 60 * 1000); // 24 horas
